  ...
  Future<void> printPos({
    ...
    doc.addPage(pw.Page(
      ...
      build: (_) => pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.stretch, children: [
        pw.Center(child: pw.Text('GAJURMUKHI DAIRY & STORE', style: const pw.TextStyle(fontSize: 13, fontWeight: pw.FontWeight.bold))),
        ...
        pw.Text('TOTAL: ${AppSettingsService.money(total)}', style: const pw.TextStyle(fontSize: 11, fontWeight: pw.FontWeight.bold)),
        ...
        if (luckyToken?.trim().isNotEmpty == true) ...[
          ...
          pw.Center(child: pw.Text('LUCKY DRAW TOKEN', style: const pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold))),
          pw.Center(child: pw.Text(luckyToken!.trim(), style: const pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold))),
