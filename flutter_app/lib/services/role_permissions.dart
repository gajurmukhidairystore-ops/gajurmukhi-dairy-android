class RolePermissions {
  ...
  static bool canAccess(String role, int destination) {
    ...
    if (role == 'collector') return [0, 3, 4, 5, 6, 8, 9, 11, 12].contains(destination);
  ...
  static bool canReceiveInventory(String role) => role == 'collector';
  ...
  static bool canMarkOrderReady(String role) => role == 'admin' || role == 'shop';
  static bool canCompleteCollectorOrder(String role) => role == 'collector';
}
